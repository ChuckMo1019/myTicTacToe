const anextquiz = document.getElementById('nextQuiz')
anextquiz.style.display = 'block';
...
const questions = [
  {
    question: "What is ZeltaGamez' real name?",
    answers: [
  ...
  {
    question: "What is ZeltaGamez' sister's name?",
    answers: [
      { text: 'Peppa', correct: false },
